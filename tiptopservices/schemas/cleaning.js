  ...
  fields: [
    {
      name: "logo",
      title: "Logo",
      description: "Upload the logo for the cleaning site",
      type: "image",
    },
    {
      name: "heading",
      title: "Heading",
      type: "string",
      description: "Enter the headline of the homepage of the cleaning site",
    },
    {
      name: "sub_heading",
      title: "Sub Heading",
    ...
    },
    {
      ...
      type: "image",
      description: "Upload the background image for the cleaning homepage",
    },
    {
      name: "facebook_link",
      title: "Facebook Link",
